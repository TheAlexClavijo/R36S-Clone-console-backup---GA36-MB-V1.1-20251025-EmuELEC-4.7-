# R36S Clone – GA36-MB V1.1 – EmuELEC 4.7 (SD Card Backup)

This repository contains a **full backup of the original SD card** from an **R36S Clone** console with **GA36-MB V1.1 motherboard**, running **EmuELEC 4.7**.
